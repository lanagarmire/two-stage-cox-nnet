...
for i in range(10):
    count += 1
    x_train = numpy.loadtxt(fname="./../../output/rna_image_tr"+str(count)+".csv",delimiter=",",skiprows=1)
    
    ytime_train = numpy.loadtxt(fname="./../../output/time_train"+str(count)+".csv",delimiter=",",skiprows=1)
    
    ystatus_train = numpy.loadtxt(fname="./../../output/sta_train"+str(count)+".csv",delimiter=",",skiprows=1)

    x_test = numpy.loadtxt(fname="./../../output/rna_image_te"+str(count)+".csv",delimiter=",",skiprows=1)

    ytime_test = numpy.loadtxt(fname="./../../output/time_test"+str(count)+".csv",delimiter=",",skiprows=1)

    ystatus_test = numpy.loadtxt(fname="./../../output/sta_test"+str(count)+".csv",delimiter=",",skiprows=1)
    ...
    numpy.savetxt('./../../output/iR_ypred_test'+str(count)+'.csv', theta, delimiter=",")
    
    numpy.savetxt('./../../output/iR_ytime_test'+str(count)+'.csv', ytime_test, delimiter=",")
    
    numpy.savetxt('./../../output/iR_ystatus_test'+str(count)+'.csv', ystatus_test, delimiter=",")
    numpy.savetxt('./../../output/iR_ypred_train'+str(count)+'.csv', theta_2, delimiter=",")
    
    numpy.savetxt('./../../output/iR_ytime_train'+str(count)+'.csv', ytime_train, delimiter=",")
    
    numpy.savetxt('./../../output/iR_ystatus_train'+str(count)+'.csv', ystatus_train, delimiter=",")
