...
for i in range(10):
    ...
    numpy.savetxt("./../../output/Wr"+str(count)+".csv", W, delimiter=",")
    numpy.savetxt("./../../output/br"+str(count)+".csv", b, delimiter=",")
    numpy.savetxt("./../../output/coxnet_rtest"+str(count)+".csv",x_test, delimiter=",")
    numpy.savetxt("./../../output/coxnnet_rtest_time"+str(count)+".csv",ytime_test,delimiter = ",")
    numpy.savetxt("./../../output/coxnnet_rtest_sta"+str(count)+".csv", ystatus_test, delimiter = ",")
    numpy.savetxt("./../../output/coxnet_rtrain"+str(count)+".csv",x_train, delimiter=",")
    numpy.savetxt("./../../output/coxnnet_rtrain_time"+str(count)+".csv",ytime_train,delimiter = ",")
    numpy.savetxt("./../../output/coxnnet_rtrain_sta"+str(count)+".csv", ystatus_train, delimiter = ",")
